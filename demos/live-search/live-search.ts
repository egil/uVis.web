...
require(['nextTick', 'shims', 'uvis/Template', 'uvis/TemplateProperty', 'uvis/TemplateEvent'], (nt, s, ut, up, ue) => {
    $(() => {
        ...
        txtSearch.properties.add('canvas', new up.uvis.ComputedTemplateProperty('canvas', (c) => {
            return c.parent.canvas;
        }, undefined, true));
        ...
        searchTerm.properties.add('canvas', new up.uvis.ComputedTemplateProperty('canvas', (c) => {
            return c.parent.canvas;
        }, undefined, true));
        
        var resultList = new ut.uvis.Template('resultList', 'html#ul', form, (t) => {
            return t.walk().get('fieldset').get('txtSearch').event('input') // gets search term
